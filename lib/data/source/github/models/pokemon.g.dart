...
GithubPokemonModel _$GithubPokemonModelFromJson(Map<String, dynamic> json) {
  ...
  return GithubPokemonModel(
    ...
    (json['typeofpokemon'] as List)?.map((e) => e as String),
    (json['weaknesses'] as List)?.map((e) => e as String) ?? [],
    (json['evolutions'] as List)?.map((e) => e as String) ?? [],
    (json['abilities'] as List)?.map((e) => e as String) ?? [],
    json['hp'] as num,
    json['attack'] as num,
    json['defense'] as num,
...
Map<String, dynamic> _$GithubPokemonModelToJson(GithubPokemonModel instance) {
  ...
  writeNotNull('typeofpokemon', instance.types?.toList());
  val['weaknesses'] = instance.weaknesses?.toList();
  val['evolutions'] = instance.evolutions?.toList();
  val['abilities'] = instance.abilities?.toList();
